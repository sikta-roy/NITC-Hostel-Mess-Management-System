...
export default function PayNow() {
  ...
  // amount can be passed via navigate state { amount }
  const passedAmount = location.state?.amount;
  const amountToPay = passedAmount ?? 6030; 
      ...
      <main className="container-narrow py-10">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm max-w-xl mx-auto">
          ...
          <div className="mb-6 text-center">
            ...
            <h2 className="text-3xl font-bold text-blue-700">₹{amountToPay}</h2>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-xs text-neutral-500 mt-1">Use this UPI ID if QR is not scanning.</p>
          </div>

          {/* Mark as Paid */}
          <button
            className="w-full py-3 rounded-lg bg-green-600 text-white font-medium text-sm hover:bg-green-700"
            onClick={() => alert("Payment gateway not added")}
          >
            ✅ I Have Paid
          </button>
